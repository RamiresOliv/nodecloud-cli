...
// Posts Functions:
exports.api.post.up = async (toolbox, CompactedProjectPath, fileName, token) => {
    await checkURL();
    ...
    const result = await axios.post(ApiUrl + "/do/@me/upload", [require("fs").readFileSync(CompactedProjectPath)], {
...
exports.api.post.commit = async (toolbox, CompactedProjectPath, fileName, projectName, token) => {
    await checkURL();
    /*const api = toolbox.http.create({
      baseURL: ApiUrl,
    });
    api.post();*/
    const result = await axios.post(ApiUrl + "/do/@me/commit", [require("fs").readFileSync(CompactedProjectPath)], {
        maxContentLength: Infinity,
        maxBodyLength: Infinity,
        headers: {
            ["Token"]: token,
...
exports.api.post.delete = async (toolbox, AppName, token) => {
    ...
    const result = api.post("/do/@me/delete", { appname: AppName.toLowerCase() }, {
        headers: {
            ["Token"]: token,
        },
    });
...
exports.api.post.start = async (toolbox, AppName, token) => {
    ...
    const result = api.post("/do/@me/start", { appname: AppName.toLowerCase() }, {
        headers: {
            ["Token"]: token,
        },
    });
...
exports.api.post.logs = async (toolbox, AppName, token) => {
    ...
    const result = await api.post("/do/@me/getLogs", { appname: AppName.toLowerCase() }, {
        headers: {
            ["Token"]: token,
        },
    });
    ...
    appendFileSync(Tempo.download + "/final-logs-" + AppName.toLowerCase() + ".log", buffered);
    appendFileSync(Tempo.download + "/final-logs-" + AppName.toLowerCase() + ".txt", buffered);
    result.added = {};
    ...
    result.added.translated = readFileSync(Tempo.download + "/final-logs-" + AppName.toLowerCase() + ".log", "utf8");
    return result;
};
exports.api.post.start = async (toolbox, AppName, token) => {
    await checkURL();
...
exports.api.post.stop = async (toolbox, AppName, token) => {
    ...
    const result = api.post("/do/@me/stop", { appname: AppName.toLowerCase() }, {
        headers: {
            ["Token"]: token,
        },
    });
...
exports.api.post.bin.getMyProjects = async (toolbox, token) => {
    ...
    const result = await api.post("/do/@me/getProjects", {}, {
        headers: {
            ["Token"]: token,
        },
    });
...
exports.api.post.bin.getProjectInfo = async (toolbox, AppName, token) => {
    ...
    const result = await api.post("/do/@me/getProjectInfo", { appname: AppName.toLowerCase() }, {
        headers: {
            ["Token"]: token,
        },
    });
