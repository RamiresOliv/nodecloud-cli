                ...
                resGetProjects.data.returns.forEach((value) => {
                    index_1.NodeCloudApi.api.post.bin
                        ...
                        if (!res || res.data.ok) {
                            ...
                            line += status;
                            line += ` | Tamanho: ${toolbox.print.colors.muted(`"` + res.data.return.projectInfos.size + `"`)}`;
                        ...
                        if (totalofRuns == resGetProjects.data.returns.length) {
                            toolbox.print.muted("");
                            toolbox.print.muted("Mais informações sobre as aplicações podem ser vistas aqui quando ligadas!");
                            toolbox.print.muted("Se deseja ver mais informações sobre uma aplicação use " +
