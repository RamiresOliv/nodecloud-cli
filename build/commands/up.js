...
exports.run = async (toolbox, args) => {
    ...
    if (!ok) {
        spinner1.fail(toolbox.print.colors.red("Falha , [NÃO AUTORIZADO] Você precisa fazer login com seu API Token. " +
    ...
    if (!response[0] && response[1] == 500) {
        ...
        spinner1.fail(toolbox.print.colors.red("Falha, o arquivo " +
